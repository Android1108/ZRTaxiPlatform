...
public class SelectCarColorActivity extends SelectListActivity {
    ...
    public static final int REQUEST_CODE = 10902;
    ...
    public static void start(Activity activity, int id) {
        Intent starter = new Intent(activity, SelectCarColorActivity.class);
