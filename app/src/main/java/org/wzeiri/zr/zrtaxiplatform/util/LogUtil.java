...
/**
 * Created by adamzfc on 2017/8/9.
 */
    ...
    public static class Builder {
        public Builder(final Context context) {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && context.getApplicationContext().getExternalCacheDir() != null)
                defaultDir = context.getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = context.getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
