...
import org.wzeiri.zr.zrtaxiplatform.ui.fragment.MyPostingAdvertisementFragment;
...
public class MyReleasePostingAdvertisementActivity extends BaseTabLayoutActivity<MyCarInfoPagerAdapter> {
    private IDriver mIDriver;

    private List<MyPostingAdvertisementFragment> mFragmentList = new ArrayList<>();
    ...
    private void loadCarInfo() {
        ...
        for (CarHelper.CarInfo carInfo : mCarInfoLst) {
            ...
            mCarIdList.add(carId);
            MyPostingAdvertisementFragment fragment = MyPostingAdvertisementFragment.newInstance(carId);
    ...
    public static void start(Context context, int id) {
        Intent starter = new Intent(context, MyReleasePostingAdvertisementActivity.class);
