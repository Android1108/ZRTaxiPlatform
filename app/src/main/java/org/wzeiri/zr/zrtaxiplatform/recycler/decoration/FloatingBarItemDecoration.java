...
public class FloatingBarItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public FloatingBarItemDecoration(Context context, Map<Integer, String> list) {
        ...
        mBackgroundPaint.setColor(ContextCompat.getColor(mContext, R.color.gray10));

        mTextPaint = new Paint();
        mTextPaint.setColor(ContextCompat.getColor(mContext, R.color.gray40));
...
//        mTextStartMargin = resources.getDimensionPixelOffset(R.dimen.layout_margin_tiny);
    }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        c.drawColor(ContextCompat.getColor(parent.getContext(), R.color.gray10));
