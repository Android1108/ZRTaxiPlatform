...
public class SendMessageCodeDialog extends BaseDialog {
    ...
    public SendMessageCodeDialog(@NonNull Context context) {
        super(context);
    }

    public SendMessageCodeDialog(@NonNull Context context, int themeResId) {
