...
import org.wzeiri.zr.zrtaxiplatform.ui.fragment.MyReleaseSeatCoverFragment;
...
public class MyReleaseSeatCoverActivity extends BaseTabLayoutActivity<MyCarInfoPagerAdapter> {
    private IDriver mIDriver;

    private List<MyReleaseSeatCoverFragment> mFragmentList = new ArrayList<>();
    ...
    private void loadCarInfo() {
        ...
        for (CarHelper.CarInfo carInfo : mCarInfoLst) {
            MyReleaseSeatCoverFragment fragment = MyReleaseSeatCoverFragment.newInstance(carInfo.getId());
    ...
    public static void start(Context context, int id) {
        Intent starter = new Intent(context, MyReleaseSeatCoverActivity.class);
